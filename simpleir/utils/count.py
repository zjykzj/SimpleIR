...
@file: count.py
@author: zj
@description: Refer to [python-统计元素个数](https://blog.csdn.net/u012991043/article/details/81020086#:~:text=python%E7%BB%9F%E8%AE%A1%E5%88%97%E8%A1%A8%E4%B8%AD%E5%85%83%E7%B4%A0,.count(i)%E3%80%91%E3%80%82)
"""
...
def count_frequency(data_list: List[int]) -> List[int]:
    ...
    sorted_indices = list(reversed(np.argsort(np.array(res_list)[:, 1])))
